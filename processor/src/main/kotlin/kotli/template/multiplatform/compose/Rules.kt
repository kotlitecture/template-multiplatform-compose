...
object Rules {
    ...
    const val AppUiDir = "${AppPresentationDir}/ui"
    const val AppUiThemeChangeDir = "${AppUiDir}/theme/change"
    const val AppUiThemeToggleDir = "${AppUiDir}/theme/toggle"
    ...
    const val AppUiLoaderDir = "${AppUiDir}/loader"
