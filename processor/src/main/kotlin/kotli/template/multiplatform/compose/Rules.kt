...
object Rules {
    ...
    const val AppScreenDir = "${AppPresentationDir}/screen"
    const val AppPresentationThemeChangeDir = "${AppScreenDir}/theme/change"
    const val AppPresentationThemeToggleDir = "${AppScreenDir}/theme.toggle"
    ...
    const val UserFlowNavigationDir = "${AppPresentationDir}/navigation"
