package kotli.template.multiplatform.compose.showcases.userflow.common.component.image
...
object CoilShowcasesProcessor : BaseShowcasesProcessor() {
    ...
    override fun doRemove(state: TemplateState) {
        removeDir(state, "${Rules.AppShowcasesUserflow}/common/component/image/coil")
