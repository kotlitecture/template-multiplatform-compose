...
fun NoArgsNavigationFromScreen() {
    ...
    FixedTopBarColumnLayout(
        ...
        content = {
            ShowcaseHintBlock(
                text = """
                    By clicking on the button below, the app will navigate to the [NoArgsNavigationToDestination] destination using a pre-configured [NavigationState] instance.
