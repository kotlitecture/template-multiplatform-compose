...
@Composable
fun ShowcasesScreen(route: kotli.app.feature.showcases.ShowcasesRoute) {
    ...
    AppFixedTopBarLazyColumn(
        ...
        content = {
            ...
            showcasesState.value.forEach { showcase ->
                when (showcase) {
                    is kotli.app.feature.showcases.ShowcaseItem -> showcaseItem(showcase, viewModel)
                    is kotli.app.feature.showcases.ShowcaseItemGroup -> showcaseItemGroup(showcase)
                }
            }
            item { AppSpacer16() }
        }
...
private fun LazyListScope.showcaseItem(
    showcase: kotli.app.feature.showcases.ShowcaseItem,
...
private fun LazyListScope.showcaseItemGroup(
    showcase: kotli.app.feature.showcases.ShowcaseItemGroup
) {
    item {
